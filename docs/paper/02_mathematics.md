...
*Figure 1D. Throughput–dissipation phase structure showing sustained coherence as a function of energy flow (E) and dissipation (D). The heatmap reveals the minimum throughput required to maintain coherence above threshold, defining the boundary between viable and non-viable structural regimes.*
